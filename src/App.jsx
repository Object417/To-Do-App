...
const App = () => {
  return (
    <div className="App" style={{ font: "normal 1rem/1.5 Arial, san-serif" }}>
      <img src="./logo.png" alt="React Logo" />
      <img src="./redux.svg" alt="React Logo" />
      <h1 style={{ textAlign: "center" }}>Hello, React.js!</h1>

      {/* prettier-ignore */}
      <div style={{maxWidth: "3rem", objectFit: "contain"}}>
